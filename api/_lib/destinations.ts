...
export const destinations: Record<string, string> = {
  ...
  // TODO: replace with the real ClickBank hoplink for this offer
  // (Affiliate Tools -> Your Affiliate Links on the vendor's page) before
  // this goes live -- the /buy redirect will 404 to "/" until this is set.
